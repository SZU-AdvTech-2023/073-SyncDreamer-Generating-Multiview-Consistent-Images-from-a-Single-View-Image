...
from ldm.ldm_utils import default
import clip
...
class FrozenT5Embedder(AbstractEncoder):
    ...
    def __init__(self, version="google/t5-v1_1-large", device="cuda",
                 max_length=77):  # others are google/t5-v1_1-xl and google/t5-v1_1-xxl
        super().__init__()
...
if __name__ == "__main__":
    from ldm.ldm_utils import count_params

    sentences = ["a hedgehog drinking a whiskey", "der mond ist aufgegangen",
